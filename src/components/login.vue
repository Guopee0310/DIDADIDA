    ...
    >
      ...
      <div class="form-container sign-up-container">
        <form >
          ...
          <span>或使用電子郵件登入</span>
          <input type="text" v-model="name" placeholder="姓名" @input="testNameSignUp" :class="{checkInput:!isValidName,correctInput:isValidName}"/>
          <span v-if="!isValidName" class="caution">請輸入有效姓名</span>

          <input type="email" v-model="email" placeholder="電子信箱" @input="testMailSignUp" :class="{checkInput:!isValidEmail,correctInput:isValidEmail}"/>
          <span v-if="!isValidEmail" class="caution">請輸入有效的信箱</span>

          <input type="password" v-model="password" placeholder="密碼" @input="testPassWordSignUp" :class="{checkInput:!isValidPassword,correctInput:isValidPassword}"/>
      ...
      <div class="form-container sign-in-container">
        <form @submit.prevent="submitSignInForm">
          ...
          <span>或使用您的帳號</span>
          <input type="email" v-model="signInEmail" placeholder="電子信箱" :class="{checkInput:!signInNotCorrect,correctInput:signInNotCorrect}" />
          <span v-if="!signInNotCorrect" class="caution">信箱或密碼錯誤</span>
          <input type="password" v-model="signInPassword" placeholder="密碼" :class="{checkInput:!signInNotCorrect,correctInput:signInNotCorrect}" />
          <span v-if="!signInNotCorrect" class="caution">信箱或密碼錯誤</span>
          <a href="#">忘記密碼?</a>
...
export default {
 ...
 mounted() {   
  ...
  methods: {
      signInMem(){
          if(this.signInEmail !== this.testEmail || this.signInPassword !== this.testPassword){
