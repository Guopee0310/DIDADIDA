  ...
  data() {
    return {
      ...
      shallow_pic: [
        ...
        { pic: '../all_images/guide/dolphin.jpg', name: '海豚' },
        { pic: '../all_images/guide/stingray.jpg', name: '魟魚' },
        { pic: '../all_images/guide/shark_pic.jpg', name: '鯊魚' },
        { pic: '../all_images/guide/killer_whale.jpg', name: '虎鯨' },
        { pic: '../all_images/guide/lionfish-711799_1280.jpg', name: '獅子魚' },
        { pic: '../all_images/guide/blue-5059268_1280.jpg', name: '斑紋刺蓋魚' },
        { pic: '../all_images/guide/longhorn-cowfish-375110_1280.jpg', name: '角箱魨' },
        { pic: '../all_images/guide/fish-7391851_1280.jpg', name: '突角鼻魚' },
        { pic: '../all_images/guide/fish-2921430_1280.jpg', name: '黃高鰭刺尾魚' },
        { pic: '../all_images/guide/pallet-doctor-fish-793369_1280.jpg', name: '擬刺尾鯛' },
        { pic: '../all_images/guide/david-clode-HDVmdzQxAds-unsplash.jpg', name: '小丑魚' }
      ],
      middle_pic: [
        { pic: '../all_images/guide/peter-boshra-j8BRxbtTwTQ-unsplash.jpg', name: '烏賊' },
        { pic: '../all_images/guide/michael-worden-7hrNYNE7x44-unsplash.jpg', name: '旗魚' },
      ...
      deep_pic: [
        ...
        { pic: '../all_images/guide/Swimming_Sea_Cucumber©NOAA-Ocean-Exploration.jpg', name: '浮游海參' },
