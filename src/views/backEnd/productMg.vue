        ...
        <ul v-for="(item, index) in allProduct" :key="index">
          ...
          <li>
            <div class="img">
              <div class="picBox">
                <img
                  :src="'../all_images/product/' + item.prod_img"
            ...
            <div class="radio_onOff">
              <label :for="'on_' + index">
                <input
                  type="radio"
                  :id="'on_' + index"
                  :name="'select_onOff_' + index"
                  :disabled="item.disabled"
                  v-model="item.prod_listed"
                  value="1"
                />
                上架
              </label>
          ...
          <li>
            <button
              class="update"
              @click="updateNews(index, $event, item)"
              v-if="item.exist"
            >
              {{ item.disabled ? "修改" : "確認" }}
            </button>
            ...
            <button
              class="insert"
              @click="createNew(index, $event, item)"
              v-if="!item.exist"
            >
              新增
            </button>
